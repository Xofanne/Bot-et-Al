...
async def queue_tts(voice_client, bot):
        ...
        if len(TTS_QUEUE[last_spoke[0]]) != 0:
                ...
                def after_play(error):
                        ...
                        asyncio.run_coroutine_threadsafe(queue_tts(voice_client, bot=bot), bot.loop)
