...
async def list_all_bugs(ctx, month: str = ""):
        await ctx.channel.send( await critter.list_all("bugs", month))
...
async def list_bug(ctx, name: str = ""):
        await ctx.channel.send( embed = await critter.list_bug(name, embed=discord.Embed()))
...
async def list_all_fish(ctx, month: str = ""):
        await ctx.channel.send(await critter.list_all("fish", month))
...
async def list_all_sea_creatures(ctx, month: str = ""):
        await ctx.channel.send(await critter.list_all("sea", month))
...
async def lisf_fish(ctx, name: str =""):
        await ctx.channel.send( embed = await critter.list_fish(name, embed = discord.Embed()))
...
async def list_villager(ctx, name:str = ""):
        await ctx.channel.send(embed = await critter.list_villager(name, embed=discord.Embed()))
